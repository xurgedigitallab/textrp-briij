...
from textrp_briij.rest.client import credential, login, register
...
class CredentialVerifyRestTestCase(unittest.HomeserverTestCase):
    servlets = [
    ...
    def prepare(self, reactor: MemoryReactor, clock: Clock, hs: HomeServer) -> None:
        self.localpart = "credential_verify_user"
        self.password = "pass"
    ...
    def test_credential_verify_rate_limited_by_ip(self) -> None:
        for _ in range(5):
