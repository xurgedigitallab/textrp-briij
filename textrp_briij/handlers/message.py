...
from textrp_briij.api.urls import ConsentURIBuilder
from textrp_briij.event_auth import validate_event_for_room_version
from textrp_briij.events import EventBase, relation_from_event
from textrp_briij.events.builder import EventBuilder
from textrp_briij.events.snapshot import (
    EventContext,
    EventPersistencePair,
    UnpersistedEventContext,
    UnpersistedEventContextBase,
)
from textrp_briij.events.utils import SerializeEventConfig, maybe_upsert_event_field
from textrp_briij.events.validator import EventValidator
from textrp_briij.handlers.directory import DirectoryHandler
from textrp_briij.handlers.worker_lock import NEW_EVENT_DURING_PURGE_LOCK_NAME
from textrp_briij.logging import opentracing
from textrp_briij.logging.context import make_deferred_yieldable, run_in_background
from textrp_briij.replication.http.send_events import ReplicationSendEventsRestServlet
...
from textrp_briij.util import log_failure, unwrapFirstError
from textrp_briij.util.async_helpers import Linearizer, gather_results
from textrp_briij.util.caches.expiringcache import ExpiringCache
from textrp_briij.util.duration import Duration
from textrp_briij.util.json import json_decoder, json_encoder
from textrp_briij.util.metrics import measure_func
from textrp_briij.visibility import get_effective_room_visibility_from_state
...
class EventCreationHandler:
    ...
    async def create_event(
        ...
        # See `textrp_briij.events.utils.EventClientSerializer.serialize_event`
        ...
        # textrp_briij.handlers.directory pointless.
