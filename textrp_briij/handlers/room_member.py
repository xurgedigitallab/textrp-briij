...
from textrp_briij import types
...
from textrp_briij.event_auth import get_named_level, get_power_level_event
from textrp_briij.events import EventBase, is_creator
from textrp_briij.events.snapshot import EventContext
from textrp_briij.handlers.pagination import PURGE_ROOM_ACTION_NAME
from textrp_briij.handlers.profile import MAX_AVATAR_URL_LEN, MAX_DISPLAYNAME_LEN
from textrp_briij.handlers.state_deltas import MatchChange, StateDeltasHandler
...
from textrp_briij.logging.opentracing import SynapseTags, set_tag, tag_args, trace
from textrp_briij.metrics import SERVER_NAME_LABEL, event_processing_positions
from textrp_briij.replication.http.push import ReplicationCopyPusherRestServlet
from textrp_briij.storage.databases.main.state_deltas import StateDelta
from textrp_briij.storage.invite_rule import InviteRule
...
from textrp_briij.util.distributor import user_left_room
...
class RoomMemberHandler(metaclass=abc.ABCMeta):
    ...
    async def update_membership(
        ...
        Params:
            ...
            action: The membership change, see textrp_briij.api.constants.Membership.
