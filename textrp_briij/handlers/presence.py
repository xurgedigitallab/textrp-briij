...
from textrp_briij.api.constants import EduTypes, EventTypes, Membership, PresenceState
...
from textrp_briij.logging.context import run_in_background
from textrp_briij.metrics import SERVER_NAME_LABEL, LaterGauge
from textrp_briij.metrics.background_process_metrics import (
    wrap_as_background_process,
)
from textrp_briij.replication.http.presence import (
    ReplicationBumpPresenceActiveTime,
    ReplicationPresenceSetState,
)
from textrp_briij.replication.http.streams import ReplicationGetStreamUpdates
from textrp_briij.replication.tcp.commands import ClearUserSyncsCommand
from textrp_briij.replication.tcp.streams import PresenceFederationStream, PresenceStream
    ...
    async def _unsafe_process(self) -> None:
        ...
        while True:
            with Measure(
                ...
                textrp_briij.metrics.event_processing_positions.labels(
