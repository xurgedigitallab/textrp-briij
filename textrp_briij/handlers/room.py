...
import textrp_briij.events.snapshot
...
from textrp_briij.events.snapshot import UnpersistedEventContext
from textrp_briij.events.utils import copy_and_fixup_power_levels_contents
from textrp_briij.handlers.relations import BundledAggregations
from textrp_briij.rest.admin._base import assert_user_is_admin
from textrp_briij.streams import EventSource
...
from textrp_briij.types.handlers import ShutdownRoomParams, ShutdownRoomResponse
from textrp_briij.types.state import StateFilter
from textrp_briij.util import stringutils
from textrp_briij.util.async_helpers import concurrently_execute
from textrp_briij.util.caches.response_cache import ResponseCache
from textrp_briij.util.duration import Duration
from textrp_briij.util.iterutils import batch_iter
from textrp_briij.util.stringutils import parse_and_validate_server_name
...
class RoomCreationHandler:
    ...
    async def _upgrade_room(
        ...
        tombstone_context: textrp_briij.events.snapshot.EventContext,
        additional_creators: list[str] | None,
        creation_event_with_context: tuple[
            EventBase, textrp_briij.events.snapshot.EventContext
        ]
        | None = None,
        auto_member: bool = False,
    ) -> str:
    ...
    ) -> tuple[EventBase, textrp_briij.events.snapshot.EventContext]:
        (
            creation_event,
    ...
    async def _send_events_for_new_room(
        ...
        async def create_event(
            ...
            for_batch: bool,
            **kwargs: Any,
        ) -> tuple[EventBase, textrp_briij.events.snapshot.UnpersistedEventContextBase]:
            """
