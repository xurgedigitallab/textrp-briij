...
from textrp_briij.api.constants import EduTypes, EventTypes, Membership
...
from textrp_briij.logging.opentracing import log_kv, set_tag, trace
from textrp_briij.metrics.background_process_metrics import (
    wrap_as_background_process,
)
from textrp_briij.replication.http.devices import (
...
from textrp_briij.storage.databases.main.client_ips import DeviceLastConnectionInfo
...
from textrp_briij.util.retryutils import (
...
class DeviceWriterHandler(DeviceHandler):
    ...
    def __init__(self, hs: "HomeServer"):
        ...
        # `textrp_briij.app.generic_worker.FederationSenderHandler` when it sees it
