...
from textrp_briij.api.constants import AccountDataTypes, EduTypes
from textrp_briij.handlers.receipts import ReceiptEventSource
from textrp_briij.logging.opentracing import trace
from textrp_briij.storage.databases.main.receipts import ReceiptInRoom
    ...
    async def get_receipts_extension_response(
        ...
        if len(relevant_room_ids) > 0:
            ...
            for room_id in relevant_room_ids:
                ...
                # `textrp_briij.handlers.sliding_sync`).
