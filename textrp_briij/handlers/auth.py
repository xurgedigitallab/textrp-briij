...
from textrp_briij.handlers.ui_auth import (
    INTERACTIVE_AUTH_CHECKERS,
    UIAuthSessionDataConstants,
)
from textrp_briij.handlers.ui_auth.checkers import UserInteractiveAuthChecker
from textrp_briij.http import get_request_user_agent
from textrp_briij.http.server import finish_request, respond_with_html
from textrp_briij.http.site import SynapseRequest
from textrp_briij.logging.context import defer_to_thread
...
from textrp_briij.types import JsonDict, Requester, StrCollection, UserID
from textrp_briij.util import stringutils as stringutils
from textrp_briij.util.async_helpers import delay_cancellation, maybe_awaitable
from textrp_briij.util.duration import Duration
from textrp_briij.util.msisdn import phone_number_to_msisdn
from textrp_briij.util.stringutils import base62_encode
...
class AuthHandler:
    ...
    async def check_ui_auth(
        ...
        textrp_briij.rest.client._base.interactive_auth_handler as a
        decorator.
        ...
        if not sid:
            ...
            # textrp_briij.rest.client.register.RegisterRestServlet.on_POST
