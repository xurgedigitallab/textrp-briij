...
from textrp_briij.media.media_storage import ReadableFileWrapper
from textrp_briij.spam_checker_api import RegistrationBehaviour
from textrp_briij.types import JsonDict, RoomAlias, UserProfile
...
def load_legacy_spam_checkers(hs: "textrp_briij.server.HomeServer") -> None:
...
class SpamCheckerModuleApiCallbacks:
    ...
    def __init__(self, hs: "textrp_briij.server.HomeServer") -> None:
    ...
    async def check_event_for_spam(
        self, event: "textrp_briij.events.EventBase"
        ...
        for callback in self._check_event_for_spam_callbacks:
            with Measure(
                ...
                if res is False or res == self.NOT_SPAM:
                    ...
                    # return value `True`
                    return textrp_briij.api.errors.Codes.FORBIDDEN, {}
                elif (
                    isinstance(res, tuple)
                    and len(res) == 2
                    and isinstance(res[0], textrp_briij.api.errors.Codes)
                    and isinstance(res[1], dict)
                ):
                    return res
                elif isinstance(res, textrp_briij.api.errors.Codes):
                    return res, {}
        ...
        should do::
            ...
            async def check_media_file_for_spam(
                ...
                if buffer.getvalue() == b"Hello World":
                    return textrp_briij.module_api.NOT_SPAM
