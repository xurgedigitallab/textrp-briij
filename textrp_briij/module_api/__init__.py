...
from textrp_briij.api import errors
from textrp_briij.api.constants import ProfileFields
...
from textrp_briij.config.repository import MediaUploadLimit
from textrp_briij.events import EventBase
from textrp_briij.events.presence_router import (
    GET_INTERESTED_USERS_CALLBACK,
    GET_USERS_FOR_STATES_CALLBACK,
    PresenceRouter,
)
from textrp_briij.events.utils import ADD_EXTRA_FIELDS_TO_UNSIGNED_CLIENT_EVENT_CALLBACK
from textrp_briij.handlers.account_data import ON_ACCOUNT_DATA_UPDATED_CALLBACK
from textrp_briij.handlers.auth import (
...
from textrp_briij.handlers.push_rules import RuleSpec, check_actions
from textrp_briij.http.client import SimpleHttpClient
...
from textrp_briij.metrics.background_process_metrics import (
    run_as_background_process as _run_as_background_process,
)
from textrp_briij.module_api.callbacks.account_validity_callbacks import (
...
from textrp_briij.module_api.callbacks.media_repository_callbacks import (
...
from textrp_briij.module_api.callbacks.ratelimit_callbacks import (
    GET_RATELIMIT_OVERRIDE_FOR_USER_CALLBACK,
    RatelimitOverride,
)
from textrp_briij.module_api.callbacks.spamchecker_callbacks import (
...
from textrp_briij.push.httppusher import HttpPusher
from textrp_briij.rest.client.login import LoginResponse
from textrp_briij.storage import DataStore
from textrp_briij.storage.background_updates import (
    DEFAULT_BATCH_SIZE_CALLBACK,
    MIN_BATCH_SIZE_CALLBACK,
    ON_UPDATE_CALLBACK,
)
from textrp_briij.storage.database import DatabasePool, LoggingTransaction
from textrp_briij.storage.databases.main.roommember import ProfileInfo
...
from textrp_briij.util.async_helpers import maybe_awaitable
from textrp_briij.util.caches.descriptors import CachedFunction, cached as _cached
...
if TYPE_CHECKING:
    ...
    from textrp_briij.app.generic_worker import GenericWorkerStore
...
class ModuleApi:
    ...
    def http_client(self) -> SimpleHttpClient:
        ...
        An instance of textrp_briij.http.client.SimpleHttpClient
    ...
    def public_room_list_manager(self) -> "PublicRoomListManager":
        ...
        An instance of textrp_briij.module_api.PublicRoomListManager
    ...
    def invalidate_access_token(
        ...
        Raises:
            textrp_briij.api.errors.AuthError: the access token is invalid
        """
        ...
        **kwargs: object,
        ...
        Args:
            f: The function to call repeatedly. f can be either synchronous or
                ...
                https://docs.briij.example/synapse/latest/log_contexts.html
    ...
    def check_push_rule_actions(self, actions: list[str | dict[str, str]]) -> None:
        ...
        Raises:
            textrp_briij.module_api.errors.InvalidRuleException if the actions are invalid.
        """
    ...
    async def set_push_rule_action(
        ...
        Raises:
            ...
            textrp_briij.module_api.errors.RuleNotFoundException if the rule being modified
                can't be found.
            textrp_briij.module_api.errors.InvalidRuleException if the actions are invalid.
        """
