...
from textrp_briij.synapse_rust.acl import ServerAclEvaluator
from textrp_briij.types import MutableStateMap, StateMap, StreamToken, get_domain_from_id
...
if TYPE_CHECKING:
    ...
    from textrp_briij.state import _StateCacheEntry
