...
from textrp_briij.storage.engines import (
    BaseDatabaseEngine,
    IncorrectDatabaseSetup,
    PostgresEngine,
)
from textrp_briij.storage.types import Connection, Cursor
...
https://github.com/matrix-org/textrp_briij.
...
class LocalSequenceGenerator(SequenceGenerator):
    ...
    def get_next_id_txn(self, txn: Cursor) -> int:
        ...
        # we are a single process textrp_briij.
        with self._lock:
