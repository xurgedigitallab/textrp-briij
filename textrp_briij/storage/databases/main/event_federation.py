...
from textrp_briij.api.constants import MAX_DEPTH
from textrp_briij.api.errors import StoreError
from textrp_briij.api.room_versions import EventFormatVersions, RoomVersion
from textrp_briij.events import EventBase, make_event_from_dict
from textrp_briij.logging.opentracing import tag_args, trace
...
from textrp_briij.storage.background_updates import ForeignKeyConstraint
from textrp_briij.storage.database import (
    DatabasePool,
    LoggingDatabaseConnection,
    LoggingTransaction,
)
from textrp_briij.storage.databases.main.cache import CacheInvalidationWorkerStore
...
from textrp_briij.types import JsonDict, StrCollection
from textrp_briij.util.caches.descriptors import cached
...
class EventFederationWorkerStore(
    ...
    def _fixup_auth_chain_difference_sets(
        ...
        # `textrp_briij.state.v2_get_auth_chain_difference`. We uses the observation
