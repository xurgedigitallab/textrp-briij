...
from textrp_briij.storage.databases.main.stream import _filter_results_by_stream
from textrp_briij.storage.engines import Sqlite3Engine
...
class RoomMemberWorkerStore(EventsWorkerStore, CacheInvalidationWorkerStore):
    ...
    async def get_rooms_for_local_user_where_membership_is(
        ...
        Args:
            user_id: The user ID.
            membership_list: A list of textrp_briij.api.constants.Membership
