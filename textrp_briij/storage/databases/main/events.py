...
from textrp_briij.api.errors import PartialStateConflictError
from textrp_briij.api.room_versions import RoomVersions
from textrp_briij.events import (
    EventBase,
    StrippedStateEvent,
    is_creator,
    relation_from_event,
)
from textrp_briij.events.snapshot import EventPersistencePair
from textrp_briij.events.utils import parse_stripped_state_event
from textrp_briij.logging.opentracing import trace
from textrp_briij.metrics import SERVER_NAME_LABEL
from textrp_briij.storage._base import db_to_json, make_in_list_sql_clause
...
from textrp_briij.storage.databases.main.event_federation import EventFederationStore
from textrp_briij.storage.databases.main.events_worker import EventCacheEntry
from textrp_briij.storage.databases.main.search import SearchEntry
from textrp_briij.storage.engines import PostgresEngine
from textrp_briij.storage.util.id_generators import AbstractStreamIdGenerator
from textrp_briij.storage.util.sequence import SequenceGenerator
...
from textrp_briij.types.handlers import SLIDING_SYNC_DEFAULT_BUMP_EVENT_TYPES
...
from textrp_briij.util.iterutils import batch_iter, sorted_topologically
from textrp_briij.util.json import json_encoder
from textrp_briij.util.stringutils import non_null_str_or_none
        ...
        *,
        ...
        async with stream_ordering_manager as stream_orderings:
            ...
            if not use_negative_stream_ordering:
                ...
                # stream_ordering.
                textrp_briij.metrics.event_persisted_position.labels(
