...
from textrp_briij.storage.database import LoggingDatabaseConnection, LoggingTransaction
from textrp_briij.storage.engines import BaseDatabaseEngine, PostgresEngine, Sqlite3Engine
from textrp_briij.storage.schema import SCHEMA_COMPAT_VERSION, SCHEMA_VERSION
...
def _upgrade_existing_database(
    ...
    if not is_empty and "main" in databases:
        from textrp_briij.storage.databases.main import check_database_before_upgrade
    ...
    for v in range(start_ver, SCHEMA_VERSION + 1):
        ...
        for entry in directory_entries:
            ...
            if ext == ".py":
                ...
                module_name = "textrp_briij.storage.v%d_%s" % (v, root_name)
