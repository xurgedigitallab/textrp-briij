...
if TYPE_CHECKING:
    ...
    from textrp_briij.appservice.api import ApplicationService
    from textrp_briij.events import EventBase
    from textrp_briij.storage.databases.main import DataStore, PurgeEventsStore
...
class IBriijReactor(
    ...
    """The interfaces necessary for Briij to function."""
