...
from textrp_briij.federation.transport.server import (
...
from textrp_briij.rest import ClientRestResource
from textrp_briij.rest.key.v2 import RemoteKey
...
def main() -> None:
    ...
    worker_paths = get_registered_paths_for_default(
        "textrp_briij.app.generic_worker", config
    )
