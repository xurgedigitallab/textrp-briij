...
from textrp_briij.storage.database import DatabasePool, LoggingTransaction, make_conn
from textrp_briij.storage.databases.main import FilteringWorkerStore
from textrp_briij.storage.databases.main.account_data import AccountDataWorkerStore
from textrp_briij.storage.databases.main.client_ips import ClientIpBackgroundUpdateStore
from textrp_briij.storage.databases.main.delayed_events import DelayedEventsStore
from textrp_briij.storage.databases.main.deviceinbox import DeviceInboxBackgroundUpdateStore
from textrp_briij.storage.databases.main.devices import DeviceBackgroundUpdateStore
from textrp_briij.storage.databases.main.e2e_room_keys import EndToEndRoomKeyBackgroundStore
from textrp_briij.storage.databases.main.end_to_end_keys import EndToEndKeyBackgroundStore
from textrp_briij.storage.databases.main.event_federation import EventFederationWorkerStore
from textrp_briij.storage.databases.main.event_push_actions import EventPushActionsStore
from textrp_briij.storage.databases.main.events_bg_updates import (
    EventsBackgroundUpdatesStore,
)
from textrp_briij.storage.databases.main.media_repository import (
    MediaRepositoryBackgroundUpdateStore,
)
from textrp_briij.storage.databases.main.presence import PresenceBackgroundUpdateStore
from textrp_briij.storage.databases.main.profile import ProfileWorkerStore
from textrp_briij.storage.databases.main.push_rule import PusherWorkerStore
from textrp_briij.storage.databases.main.pusher import PusherBackgroundUpdatesStore
from textrp_briij.storage.databases.main.receipts import ReceiptsBackgroundUpdateStore
from textrp_briij.storage.databases.main.registration import (
    RegistrationBackgroundUpdateStore,
    find_max_generated_user_id_localpart,
)
from textrp_briij.storage.databases.main.relations import RelationsWorkerStore
from textrp_briij.storage.databases.main.room import RoomBackgroundUpdateStore
from textrp_briij.storage.databases.main.roommember import RoomMemberBackgroundUpdateStore
from textrp_briij.storage.databases.main.search import SearchBackgroundUpdateStore
from textrp_briij.storage.databases.main.sliding_sync import SlidingSyncStore
from textrp_briij.storage.databases.main.state import MainStateBackgroundUpdateStore
...
from textrp_briij.storage.databases.state.bg_updates import StateBackgroundUpdateStore
...
reactor = cast(IBriijReactor, reactor_)
...
def main() -> None:
    ...
    logging.basicConfig(
        ...
        filename="port-textrp_briij.log" if args.curses else None,
    )
