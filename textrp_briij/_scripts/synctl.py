...
from textrp_briij.config import find_config_files

MAIN_PROCESS = "textrp_briij.app.homeserver"
...
def main() -> None:
    ...
    if options.all_processes:
        ...
        # with worker_app == "textrp_briij.app.homeserver"
        start_stop_synapse = False
    ...
    for worker_configfile in worker_configfiles:
        ...
        if worker_app == "textrp_briij.app.homeserver":
