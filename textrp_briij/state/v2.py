...
from textrp_briij.api.constants import CREATOR_POWER_LEVEL, EventTypes
from textrp_briij.api.errors import AuthError
from textrp_briij.api.room_versions import RoomVersion, StateResolutionVersions
...
from textrp_briij.types import MutableStateMap, StateMap, StrCollection
...
class Clock(Protocol):
    # This is usually textrp_briij.util.Clock, but it's replaced with a FakeClock in tests.
...
class StateResolutionStore(Protocol):
    # This is usually textrp_briij.state.StateResolutionStore, but it's replaced with a
