...
from textrp_briij.logging import context
from textrp_briij.logging.loggers import ExplicitlyConfiguredLogger
from textrp_briij.types import ISynapseThreadlessReactor
from textrp_briij.util import log_failure
...
clock_debug_logger = logging.getLogger("textrp_briij.util.clock.debug")
"""
...
this, they must explicitly set `textrp_briij.util.clock.debug` in the logging configuration. Note that
...
class Clock:
    ...
    `scripts-dev/mypy_briij_plugin.py`.
