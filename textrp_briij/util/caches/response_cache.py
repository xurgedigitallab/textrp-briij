...
from textrp_briij.util.caches import EvictionReason, register_cache
from textrp_briij.util.cancellation import cancellable, is_function_cancellable
...
class ResponseCache(Generic[KV]):
    ...
    def _set(
        ...
        *deferred* should run its callbacks in the sentinel logcontext (ie,
        ...
        textrp_briij.logging.context.run_in_background).
