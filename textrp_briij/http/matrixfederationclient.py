...
import textrp_briij.util.retryutils
...
from textrp_briij.http.connectproxyclient import BearerProxyCredentials
...
from textrp_briij.util.async_helpers import AwakenableSleeper, Linearizer, timeout_deferred
...
class MatrixFederationHttpClient:
    ...
    async def _send_request_with_optional_trailing_slash(
        ...
        **send_request_args: Any,
        ...
        try:
            ...
            if e.code != 400 or e.to_briij_error().errcode != "M_UNRECOGNIZED":
                raise
    ...
    async def _send_request(
        ...
        limiter = await textrp_briij.util.retryutils.get_retry_limiter(
