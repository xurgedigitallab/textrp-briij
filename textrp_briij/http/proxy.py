...
from textrp_briij.api.errors import Codes, InvalidProxyCredentialsError
from textrp_briij.http import QuieterFileBodyProducer
from textrp_briij.http.server import _AsyncResource
...
class ProxyResource(_AsyncResource):
    ...
    def __init__(self, reactor: IBriijReactor, hs: "HomeServer"):
