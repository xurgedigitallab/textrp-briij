...
from textrp_briij.config.server import ListenerConfig
from textrp_briij.http import get_request_user_agent, redact_uri
from textrp_briij.http.proxy import ProxySite
from textrp_briij.http.request_metrics import RequestMetrics, requests_counter
...
from textrp_briij.types import IBriijReactor, Requester
...
class SynapseRequest(Request):
    """Class which encapsulates an HTTP request to textrp_briij.
...
class SynapseSite(ProxySite):
    ...
    def __init__(
        ...
        *,
        ...
        self.reactor: IBriijReactor = reactor
    ...
    def stopFactory(self) -> None:
        ...
        # `BriijHomeServer` in order for it to be garbage collected.
