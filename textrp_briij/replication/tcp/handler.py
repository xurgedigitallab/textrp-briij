...
from textrp_briij.replication.tcp.context import ClientContextFactory
...
class ReplicationCommandHandler:
    ...
    def start_replication(self, hs: "HomeServer") -> None:
        ...
        from textrp_briij.replication.tcp.redis import RedisDirectTcpReplicationClientFactory
