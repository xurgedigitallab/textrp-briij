...
class ReplicationRemovePusherRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/remove_pusher/:user_id
...
class ReplicationCopyPusherRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/copy_push_rules/:user_id/:old_room_id/:new_room_id
...
class ReplicationDeleteAllPushersForUserRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/delete_all_pushers_for_user/:user_id
