...
class ReplicationAddUserAccountDataRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/add_user_account_data/:user_id/:type
...
class ReplicationRemoveUserAccountDataRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/remove_user_account_data/:user_id/:type
...
class ReplicationAddRoomAccountDataRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/add_room_account_data/:user_id/:room_id/:account_data_type
...
class ReplicationRemoveRoomAccountDataRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/remove_room_account_data/:user_id/:room_id/:account_data_type
...
class ReplicationAddTagRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/add_tag/:user_id/:room_id/:tag
...
class ReplicationRemoveTagRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/remove_tag/:user_id/:room_id/:tag
