...
from textrp_briij.logging.opentracing import active_span
from textrp_briij.replication.http._base import ReplicationEndpoint
from textrp_briij.types import JsonDict, JsonMapping
...
class ReplicationNotifyDeviceUpdateRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/notify_device_update/:user_id
...
class ReplicationNotifyUserSignatureUpdateRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/notify_user_signature_update/:from_user_id
...
class ReplicationMultiUserDevicesResyncRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/multi_user_device_resync
...
class ReplicationHandleNewDeviceUpdateRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/handle_new_device_update
...
class ReplicationDeviceHandleRoomUnPartialStated(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_briij/replication/device_handle_room_un_partial_stated/:room_id
