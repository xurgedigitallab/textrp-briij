...
from textrp_briij.config.server import is_threepid_reserved
from textrp_briij.handlers.auth import AuthHandler
from textrp_briij.handlers.ui_auth import UIAuthSessionDataConstants
from textrp_briij.http.server import HttpServer, finish_request, respond_with_html
...
from textrp_briij.metrics import SERVER_NAME_LABEL, threepid_send_requests
from textrp_briij.push.mailer import Mailer
...
from textrp_briij.util.stringutils import assert_valid_client_secret, random_string
from textrp_briij.util.threepids import (
    canonicalise_email,
    check_3pid_allowed,
    validate_email,
)
...
class RegisterRestServlet(RestServlet):
    ...
    async def _do_guest_registration(
        ...
        device_id = textrp_briij.api.auth.GUEST_DEVICE_ID
        initial_display_name = params.get("initial_device_display_name")
        (
            device_id,
            access_token,
