...
from textrp_briij.api.constants import Direction
...
from textrp_briij.rest.admin._base import (
    admin_patterns,
    assert_requester_is_admin,
    assert_user_is_admin,
)
from textrp_briij.rest.client._base import client_patterns
from textrp_briij.storage.databases.main.registration import ExternalIDReuseException
from textrp_briij.storage.databases.main.stats import UserSortOrder
from textrp_briij.types import JsonDict, JsonMapping, TaskStatus, UserID
from textrp_briij.types.rest import RequestBodyModel
...
user_registration_sensitive_debug_logger = logging.getLogger(
    "textrp_briij.rest.admin.users.registration_debug"
)
"""
...
in the logs. Requires explicitly setting `textrp_briij.rest.admin.users.registration_debug`
...
class UserRegisterServlet(RestServlet):
    ...
    async def on_POST(self, request: SynapseRequest) -> tuple[int, JsonDict]:
            ...
            if user_registration_sensitive_debug_logger.isEnabledFor(logging.DEBUG):
                ...
                logger.debug(
                    (
                        ...
                        "If you need more information, explicitly enable the `textrp_briij.rest.admin.users.registration_debug` "
        ...
        from textrp_briij.rest.client.register import RegisterRestServlet
