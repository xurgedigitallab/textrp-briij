...
from textrp_briij.handlers.pagination import PURGE_HISTORY_ACTION_NAME
...
from textrp_briij.rest.admin.background_updates import (
    BackgroundUpdateEnabledRestServlet,
    BackgroundUpdateRestServlet,
    BackgroundUpdateStartJobRestServlet,
)
from textrp_briij.rest.admin.devices import (
    DeleteDevicesRestServlet,
    DeviceRestServlet,
    DevicesRestServlet,
)
from textrp_briij.rest.admin.event_reports import (
    EventReportDetailRestServlet,
    EventReportsRestServlet,
)
from textrp_briij.rest.admin.events import (
    EventRestServlet,
)
from textrp_briij.rest.admin.experimental_features import ExperimentalFeaturesRestServlet
from textrp_briij.rest.admin.federation import (
...
from textrp_briij.rest.admin.mcredits import (
    AdminMcreditPackagesRestServlet,
...
from textrp_briij.rest.admin.rooms import (
    AdminRoomHierarchy,
...
from textrp_briij.rest.admin.scheduled_tasks import ScheduledTasksRestServlet
from textrp_briij.rest.admin.server_notice_servlet import SendServerNoticeServlet
from textrp_briij.rest.admin.statistics import (
    LargestRoomsStatistics,
    UserMediaStatisticsRestServlet,
)
from textrp_briij.rest.admin.username_available import UsernameAvailableRestServlet
from textrp_briij.rest.admin.users import (
...
from textrp_briij.types import JsonDict, RoomStreamToken, TaskStatus
...
def register_servlets(hs: "HomeServer", http_server: HttpServer) -> None:
    ...
    AdminMcreditPackagesRestServlet(hs).register(http_server)
