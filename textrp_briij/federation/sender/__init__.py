...
from textrp_briij.federation.sender.per_destination_queue import (
    CATCHUP_RETRY_INTERVAL,
    PerDestinationQueue,
)
from textrp_briij.federation.sender.transaction_manager import TransactionManager
from textrp_briij.federation.units import Edu
...
from textrp_briij.util.retryutils import filter_destinations_by_retry_limiter
            ...
            while not self._is_shutdown:
                ...
                async def handle_event(event: EventBase) -> None:
                    ...
                    if sharded_destinations:
                        ...
                        textrp_briij.metrics.event_processing_lag_by_event.labels(
                ...
                if event_entries:
                    ...
                    textrp_briij.metrics.event_processing_lag.labels(
                        name="federation_sender",
                        **{SERVER_NAME_LABEL: self.server_name},
                    ).set(now - ts)
                    textrp_briij.metrics.event_processing_last_ts.labels(
                        name="federation_sender",
                        **{SERVER_NAME_LABEL: self.server_name},
                    ).set(ts)
