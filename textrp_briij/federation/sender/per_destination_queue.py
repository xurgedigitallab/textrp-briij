...
from textrp_briij.logging.opentracing import SynapseTags, set_tag
from textrp_briij.metrics import SERVER_NAME_LABEL, sent_transactions_counter
...
class PerDestinationQueue:
    ...
    def __init__(
        ...
        transaction_manager: "textrp_briij.federation.sender.TransactionManager",
        destination: str,
    ):
