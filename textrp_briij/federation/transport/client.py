...
from textrp_briij.api.constants import Direction, Membership
...
from textrp_briij.http.matrixfederationclient import ByteParser, LegacyJsonSendParser
...
if TYPE_CHECKING:
    from textrp_briij.app.homeserver import HomeServer
...
class TransportLayerClient:
    ...
    async def get_public_rooms(
        ...
        See textrp_briij.federation.federation_client.FederationClient.get_public_rooms for
        more information.
        """
