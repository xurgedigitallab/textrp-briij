...
"""This is an implementation of a Matrix homeserver for Briij by TextRP."""
...
from textrp_briij.util.rust import check_rust_lib_up_to_date
from textrp_briij.util.stringutils import strtobool
...
if py_version < (3, 10):
    print("Briij by TextRP requires Python 3.10 or above.")
    sys.exit(1)
...
import textrp_briij.util  # noqa: E402

__version__ = textrp_briij.util.SYNAPSE_VERSION
