...
from textrp_briij.util.templates import _create_mxc_to_http_filter, _format_ts_filter
...
# https://docs.briij.example/synapse/latest/usage/configuration/config_documentation.html
"""
...
class Config:
    ...
    def __init__(self, root_config: "RootConfig"):
        ...
        # Get the path to the default Briij by TextRP template directory
    ...
    def read_templates(
        ...
        # TODO: switch to textrp_briij.util.templates.build_jinja_env
