...
from textrp_briij.config._base import Config, ConfigError
...
unless 'room_invite_state_types' is removed. See the config documentation at
    https://docs.briij.example/synapse/latest/usage/configuration/config_documentation.html#room_prejoin_state
