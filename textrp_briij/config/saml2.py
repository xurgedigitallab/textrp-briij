...
from textrp_briij.util.module_loader import load_module, load_python_module
...
DEFAULT_USER_MAPPING_PROVIDER = "textrp_briij.handlers.saml.DefaultSamlMappingProvider"
...
LEGACY_USER_MAPPING_PROVIDER = (
    "textrp_briij.handlers.saml_handler.DefaultSamlMappingProvider"
)
