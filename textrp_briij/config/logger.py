...
# [2]: https://docs.briij.example/synapse/latest/structured_logging.html
...
handlers:
    ...
    buffer:
        class: textrp_briij.logging.handlers.PeriodicallyFlushingMemoryHandler
        target: file
...
https://docs.briij.example/synapse/v1.54/structured_logging.html
"""
...
def _setup_stdlib_logging(
    ...
    if log_config_path is None:
        ...
        logging.getLogger("textrp_briij.storage.SQL").setLevel(logging.INFO)
...
def setup_logging(
    ...
    from textrp_briij.app import _base as appbase
    ...
    logger.warning(
        "Licensed under the AGPL 3.0 license. Website: https://github.com/textrp/briij-synapse"
    )
