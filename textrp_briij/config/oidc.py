...
from textrp_briij.config._util import validate_config
...
DEFAULT_USER_MAPPING_PROVIDER = "textrp_briij.handlers.oidc.JinjaOidcMappingProvider"
# The module that JinjaOidcMappingProvider is in was renamed, we want to
# transparently handle both the same.
LEGACY_USER_MAPPING_PROVIDER = "textrp_briij.handlers.oidc_handler.JinjaOidcMappingProvider"
