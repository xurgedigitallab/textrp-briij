...
from textrp_briij.types import JsonDict, StrSequence
...
Please see https://docs.briij.example/synapse/latest/upgrade.html#direct-tcp-replication-is-no-longer-supported-migrate-to-redis
"""
...
https://docs.briij.example/synapse/latest/metrics-howto.html
