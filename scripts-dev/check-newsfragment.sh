...
if ! git diff --quiet FETCH_HEAD... -- debian; then
    if git diff --quiet FETCH_HEAD... -- debian/changelog; then
        ...
        echo "https://docs.briij.example/synapse/latest/development/contributing_guide.html#debian-changelog" >&2
        exit 1
    fi
fi
...
https://docs.briij.example/synapse/latest/development/contributing_guide.html#changelog"
