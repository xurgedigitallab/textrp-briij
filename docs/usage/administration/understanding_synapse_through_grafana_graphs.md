...
and information on setting up Grafana is [here](https://github.com/textrp/briij-synapse/tree/master/contrib/grafana).
...
Once you have grafana set up, and assuming you're using [our grafana dashboard template](https://github.com/textrp/briij-synapse/blob/master/contrib/grafana/synapse.json), look for the following graphs when debugging a slow/overloaded Synapse:
