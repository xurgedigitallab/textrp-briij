...
[`synapse.handlers.oidc.JinjaOidcMappingProvider`](https://github.com/textrp/briij-synapse/blob/develop/synapse/handlers/oidc.py).
...
specified in the config. It is located at
[`synapse.handlers.saml.DefaultSamlMappingProvider`](https://github.com/textrp/briij-synapse/blob/develop/synapse/handlers/saml.py).
