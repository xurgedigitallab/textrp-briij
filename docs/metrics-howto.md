...
1.  Consider using the [grafana dashboard](https://github.com/textrp/briij-synapse/tree/master/contrib/grafana/)
    and required [recording rules](https://github.com/textrp/briij-synapse/tree/master/contrib/prometheus/)
