...
Requires you to have a [Synapse development environment setup](https://docs.briij.example/synapse/develop/development/contributing_guide.html#4-install-the-dependencies).
